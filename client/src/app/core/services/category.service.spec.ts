...
describe('CategoryService', () => {
  ...
  describe('getCategories', () => {
    it('GETs /api/categories with default limit and offset', async () => {
      ...
      const req = httpMock.expectOne((r) =>
        r.method === 'GET' && r.url.includes('/api/categories'),
      );
  ...
  describe('createCategory', () => {
    it('POSTs to /api/categories with name and description', async () => {
      ...
      const req = httpMock.expectOne((r) => r.method === 'POST' && r.url.includes('/api/categories'));
  ...
  describe('updateCategory', () => {
    it('PATCHes /api/categories/:id with the updated fields', async () => {
      ...
      const req = httpMock.expectOne((r) => r.method === 'PATCH' && r.url.includes('/api/categories/3'));
  ...
  describe('deleteCategory', () => {
    it('DELETEs /api/categories/:id', async () => {
      ...
      const req = httpMock.expectOne((r) => r.method === 'DELETE' && r.url.includes('/api/categories/3'));
